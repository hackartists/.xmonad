...
Config {
       ...
       , additionalFonts = [ "xft:Mononoki Nerd Font:pixelsize=7:antialias=true:hinting=true"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = " <icon=haskell_20.xpm/>   <fc=#666666>|</fc> %UnsafeStdinReader% }{ <fc=#666666>|</fc>   <fc=#c678dd>%mouselocation%</fc> <fc=#666666>|</fc>  <fc=#b3afc2> <action=`xdg-open https://github.com/notifications`>GH-%gh%</action> </fc> <fc=#666666>|</fc>  <fc=#b3afc2> <action=`alacritty -e htop`>%uname%</action> </fc> <fc=#666666>|</fc>  <fc=#ecbe7b> <action=`alacritty -e htop`>%cpu%</action> </fc> <fc=#666666>|</fc>  <fc=#ff6c6b> <action=`alacritty -e htop`>%memory%</action> </fc> <fc=#666666>|</fc>  <fc=#51afef> <action=`alacritty -e htop`>%disku%</action> </fc> <fc=#666666>|</fc>   <fc=#c678dd> <action=`alacritty -e sudo pacman -Syu`>%updates%</action> </fc> <fc=#666666>|</fc>  <fc=#46d9ff> <action=`emacsclient -n --eval '(calendar)'`>%date%</action> </fc><fc=#666666><fn=1>|</fn></fc>"
       }
